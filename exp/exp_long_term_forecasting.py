...
class Exp_Long_Term_Forecast(Exp_Basic):
    """
    Experiment class for Long-Term Forecasting tasks.
    """
    ...
    def __init__(self, args: Any):
        ...
        logger.info("Initialized Exp_Long_Term_Forecast.")
    ...
    def _select_criterion(self) -> nn.Module:
        ...
        logger.info("MSELoss criterion selected.")
        return criterion
    ...
    def test(self, setting: str, test_flag: int = 0) -> None:
        ...
        logger.info(f"Imputation Metrics - MSE: {mse}, MAE: {mae}, DTW: {dtw}")
